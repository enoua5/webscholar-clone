...
const routes: Routes = [
    ...
    {
        path: 'forgot_password_submission',
        component: ForgotPasswordSubmissionComponent
    },
    ...
    {
        path: 'studentviewscholarship',
        component: StudentViewScholarshipFormComponent
    },
    {
        path: 'registration_invitation_form',
        component: RegistrationInvitationFormComponent
    },
    {
        path: 'scholarship/apply/:id',
        component: StudentViewScholarshipApplicationComponent
    },
