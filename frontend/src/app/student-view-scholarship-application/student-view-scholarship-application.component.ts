...
export class StudentViewScholarshipApplicationComponent
{
  ...
  constructor()
  {
    ...
    this.description = "A scholarship given in honor of the late, great Dr. Richard Daystrom.";
    this.requirements = "Recipients must be majoring in warp field computation.";
    this.amount = 3000.00;
  }
