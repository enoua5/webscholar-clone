...
public class Client {
	...
	private String clientId; // The ID used for authentication and authorization
	
	@Column(name="client_secret")
	private String clientSecret; // The password used for authentication and authorization
